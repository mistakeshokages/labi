...
function generateResultLink() {
  const resultLinks = {
    1: `<p>Результат виконання лабораторної роботи №1</p>`,
    ...
    4: `<a class="text-blue-400" href="pages/lab4/lab4_1.html" target="_blank">Завдання 1 </a><br>
        <a class="text-blue-400 "href="pages/lab4/lab4_2.html" target="_blank">Завдання 2 (варіант 4)</a>`,
    8: `<p>Результат виконання лабораторної роботи №8</p>`,
    9: `<a class="text-blue-400 "href="pages/lab9/data.xml" target="_blank">Результат виконання лабораторної роботи №9</a>`
